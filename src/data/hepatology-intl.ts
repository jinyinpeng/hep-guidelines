...
export const INTL_GUIDELINES: Guideline[] = [
  ...
  /* ================= EASL 2025 年新发布指南 ================= */
  {
    ...
    topic: 'hbv',
    latest: true,
    tags: ['治疗适应证扩大', 'NAs 与 Peg-IFN', 'HCC 监测', '再激活预防'],
    summary:
      '时隔 8 年全面更新：原则上「HBV DNA 可检出即可治疗」，弃用传统免疫分期以避免「不确定期」延误治疗，并把核苷（酸）类似物与聚乙二醇干扰素并列为一线。',
    ref: 'EASL Clinical Practice Guidelines on the management of hepatitis B virus infection（J Hepatol 2025；S0168-8278(25)00174-6；2025 年 5 月 8 日发布）；条目要点参照雨露肝霖公众号对该指南的整理稿，逐条推荐强度与证据等级以原文为准',
    grading:
      'EASL 2025：推荐意见分强/弱推荐并标注证据等级；本条目仅在来源明确给出时照录「强推荐」「强共识」，未取得逐条等级的推荐一律留空',
    sections: [
      {
        title: '版本规模与总体变化',
        points: [
          { t: '共分 10 个主题、30 个临床问题，给出 112 条推荐意见与 13 条陈述，引用 778 篇参考文献，是 2017 版之后时隔 8 年的全面更新。', tag: '规模', key: true },
          { t: '三项核心变化：治疗目标分层（HBV DNA 检测不到为首要目标、HBsAg 清除为最终目标）、治疗适应证大幅扩大并简化流程、NAs 与 Peg-IFNα 并列为一线。', tag: '关键更新', key: true },
          { t: '同时更新了肝细胞癌监测、HBV 再激活预防、肝移植围术期管理、疫苗血清保护阈值与筛查策略等模块。', tag: '范围' },
        ],
      },
      {
        title: '治疗目标（1 个临床问题 / 1 条陈述）',
        points: [
          { t: '首要目标：持续抑制 HBV DNA，最好达到检测不到。', tag: '目标', rec: '强共识', key: true },
          { t: '最终目标：HBsAg 清除；附加终点为 ALT 恢复正常。', tag: '目标', rec: '强共识', key: true },
          { t: '临床终点仍是减少肝硬化、肝功能失代偿、肝衰竭与肝细胞癌，提高生存率。', tag: '临床终点', key: true },
        ],
      },
      {
        title: '治疗适应证：门槛显著放宽',
        points: [
          { t: '原则性推荐：所有 HBsAg 阳性且能检测到 HBV DNA 的个体都适合抗病毒治疗。', tag: '适应证', rec: '强共识', key: true },
          { t: '治疗指征主要基于 HBV DNA 与 ALT 水平、纤维化严重程度、肝病进展与肝细胞癌风险，而非依赖单一指标。', tag: '指征', key: true },
          { t: '新增推荐：HBV DNA 持续低水平（< 2000 IU/mL）而 ALT 持续升高（> 正常值上限）者，可考虑抗病毒治疗。', tag: '新增', key: true },
          { t: '免疫耐受期患者也可能从早期抗病毒治疗中获益（原文为「可能」表述，未作无差别强推荐）。', tag: '免疫耐受期' },
          { t: '简化流程：不再依赖 HBeAg 状态与传统免疫分期，以避免「不确定期」患者延误治疗。', tag: '流程', rec: '强共识', key: true },
        ],
      },
      {
        title: '治疗选择与停药（5 个临床问题 / 24 条推荐）',
        points: [
          { t: '推荐两类治疗选择：核苷（酸）类似物（NAs）与聚乙二醇干扰素 α（Peg-IFNα）。', tag: '方案', rec: '强共识', key: true },
          { t: '在综合考虑方案特点与患者意愿的基础上，NAs 与 Peg-IFNα 均可作为一线治疗药物。', tag: '一线', rec: '强共识', key: true },
          { t: '相较 2017 版，耐药处理流程与建议更详细，NAs 停药给出新的推荐意见，对 Peg-IFNα 的治疗态度相对更积极。', tag: '与旧版差异', key: true },
          { t: '停药规则按「停药时 HBsAg 是否已清除」两种情形分别给出——HBsAg 消失与 HBsAg 阳性对应不同的感染状态，处理原则不同，具体标准见原文。', tag: '停药', key: true },
        ],
      },
      {
        title: '肝癌监测与特殊人群',
        points: [
          { t: '2017 版没有独立的肝癌监测模块；2025 版单列该模块并扩大监测范围，明确所有高危人群均应接受肝细胞癌监测。', tag: 'HCC 监测', key: true },
          { t: '同时优化了风险评估方式，用于确定监测人群与随访间隔。', tag: 'HCC 监测' },
          { t: '特殊人群用 8 个临床问题、29 条推荐细化，覆盖妊娠、儿童、合并 HIV 或 HDV 感染、肾功能不全与移植受者等。', tag: '特殊人群', key: true },
          { t: '肝移植部分（3 个临床问题、12 条推荐）细化乙肝免疫球蛋白（HBIG）的使用时机与调整依据：应在无肝期开始使用，并按抗-HBs 滴度调整剂量。', tag: '肝移植', key: true },
        ],
      },
      {
        title: 'HBV 再激活预防（1 个临床问题 / 7 条推荐）',
        points: [
          { t: '预防决策需综合三项信息：HBV 标志物（HBsAg、抗-HBc、HBV DNA）、计划实施的免疫抑制方案、以及需要免疫抑制治疗的基础疾病。', tag: '评估', key: true },
          { t: '开始免疫抑制治疗前，必须评价患者的 HBsAg 与抗-HBc 状况。', tag: '前置筛查', key: true },
          { t: '指南对预防性抗病毒的疗程给出详细说明，具体时长与停药时机以原文为准。', tag: '疗程' },
        ],
      },
      {
        title: '筛查、预防与免疫保护阈值',
        points: [
          { t: '初次筛查 HBV 感染应同时检测 HBsAg 与抗-HBc。', tag: '筛查', rec: '强推荐', key: true },
          { t: '明确应接受 HBV 筛查的个体范围，并提倡在风险人群之外开展以人群为基础的筛查，以发现未诊断病例，尤其在中至高度流行地区。', tag: '筛查', rec: '强推荐', key: true },
          { t: '血清保护标准为抗-HBs ≥ 10 IU/L。', tag: '阈值', key: true },
          { t: '免疫功能低下等重症高风险人群，最后一剂疫苗接种后 1–2 个月抗-HBs ≥ 100 IU/L 为最佳，可能具有终身保护作用。', tag: '疫苗', rec: '强共识', key: true },
          { t: '指南另提出 12 个尚未解决的问题与研究方向。', tag: '待解决' },
        ],
      },
    ],
  },
