...
export const RENAL: Guideline[] = [
...

  {
    ...
    dept: 'renal',
    year: 2023,
    tags: ['急性肾损伤', 'KDIGO 分期', '肾前性', '肾脏替代'],
    summary: '规范急性肾损伤的诊断分期、病因鉴别、液体管理与替代治疗时机。',
    ref: '建议核对是否有更新版本',
    sections: [
      {
        title: '诊断与鉴别',
        points: [
          { t: 'AKI 定义为 48 小时内血肌酐升高 ≥26.5 μmol/L，或 7 天内升至基线 1.5 倍以上，或尿量 <0.5 mL/(kg·h) 持续 6 小时。', tag: '定义', key: true },
          { t: '按 KDIGO 标准分 1–3 期，分级越高预后越差。', tag: '分期', key: true },
          { t: '按病因分为肾前性、肾性与肾后性，需首先排除梗阻（肾后性）以免延误。', tag: '分型', key: true },
          { t: '推荐尿沉渣镜检、尿钠与肾脏超声作为基础鉴别手段。', tag: '检查', key: true },
        ],
      },
      {
        title: '处理',
        points: [
          { t: '纠正可逆病因是核心：容量不足者补液、梗阻者解除梗阻、停用肾毒性药物。', tag: '核心', key: true },
          { t: '推荐使用平衡盐溶液而非生理盐水进行液体复苏，以减少高氯性酸中毒。', tag: '液体', key: true },
          { t: '不推荐使用小剂量多巴胺或利尿剂以「预防」AKI 或改善预后。', tag: '不推荐', key: true },
          { t: '出现难治性高钾、严重酸中毒、容量过负荷或尿毒症症状时应启动肾脏替代治疗。', tag: '透析指征', key: true },
          { t: '多数 AKI 患者需随访肾功能，警惕进展为慢性肾脏病。', tag: '随访', key: true },
        ],
      },
    ],
  },
  {
    id: 'cn-kidney-transplant',
    title: '中国肾移植临床诊疗指南',
    short: '肾移植指南',
    org: '中华医学会器官移植学分会',
    region: 'cn',
    dept: 'renal',
    year: 2023,
    tags: ['肾移植', '免疫抑制', '排斥反应', '供受体评估'],
    summary: '规范肾移植的供受体评估、免疫抑制方案与排斥反应处理。',
    ref: '建议核对是否有更新版本与中华医学会器官移植学分会发布信息',
    sections: [
      {
        title: '评估与手术',
        points: [
          { t: '肾移植是终末期肾病最理想的肾脏替代方式，生存质量与生存期均优于长期透析。', tag: '定位', key: true },
          { t: '术前需评估心血管风险、活动性感染与肿瘤，并进行组织配型与交叉配型。', tag: '评估', key: true },
          { t: '推荐活体供肾优先，供者需评估肾功能、传染病与长期风险。', tag: '供者', key: true },
          { t: 'ABO 血型不合或高致敏受者需制定个体化脱敏或配对方案。', tag: '特殊', key: true },
        ],
      },
      {
        title: '免疫抑制与并发症',
        points: [
          { t: '常用方案为钙调磷酸酶抑制剂 + 抗代谢药 + 糖皮质激素的三联免疫抑制。', tag: '方案', key: true },
          { t: '按发生时间与机制分为超急性、急性与慢性排斥反应，急性排斥多以血肌酐升高伴尿量减少起病。', tag: '排斥', key: true },
          { t: '移植后需重点防治巨细胞病毒、BK 病毒、肺孢子菌与结核感染。', tag: '感染', key: true },
          { t: '长期需监测钙调磷酸酶抑制剂血药浓度、肾功能与移植后糖尿病、骨质疏松等代谢并发症。', tag: '随访', key: true },
        ],
      },
    ],
  },
  {
    id: 'cn-adpkd',
    title: '常染色体显性多囊肾病诊治中国专家共识',
    short: '多囊肾病共识',
    org: '中华医学会肾脏病学分会',
    region: 'cn',
    dept: 'renal',
    year: 2021,
    tags: ['多囊肾', '遗传性肾病', '托伐普坦', '颅内动脉瘤'],
    summary: '规范多囊肾病的诊断标准、并发症筛查与延缓进展治疗。',
    ref: '建议核对是否有更新版本',
    sections: [
      {
        title: '诊断与筛查',
        points: [
          { t: '常染色体显性多囊肾病是最常见的遗传性肾病，多成年起病，表现为双肾多发囊肿、腰痛、血尿与高血压。', tag: '特点', key: true },
          { t: '有家族史者依据影像学囊肿数量与年龄即可临床诊断，无家族史者可行基因检测。', tag: '诊断', key: true },
          { t: '推荐筛查颅内动脉瘤（尤其有家族史或既往破裂者），并评估肝囊肿、心脏瓣膜病。', tag: '筛查', key: true },
          { t: '需与多囊性肾发育不良、单纯性肾囊肿、结节性硬化鉴别。', tag: '鉴别' },
        ],
      },
      {
        title: '治疗',
        points: [
          { t: '控制血压是延缓进展的关键，首选血管紧张素系统抑制剂。', tag: '核心', key: true },
          { t: '推荐大量饮水、限盐、控制体重，避免咖啡因与快速生长的囊肿刺激因素。', tag: '基础', key: true },
          { t: '快速进展的高危患者可考虑托伐普坦以延缓肾功能下降，需监测肝功能与血钠。', tag: '药物', key: true },
          { t: '终末期患者首选肾移植，一般不主张单纯囊肿去顶减压术作为常规治疗。', tag: '终末', key: true },
        ],
      },
    ],
  },
